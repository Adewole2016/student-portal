...
SECRET_KEY = "django-insecure-x!jm)l^q)1(6-u0_@wf2yr#lx$ujm4xplz+d1-c0brbv@s_u2q"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["127.0.0.1:8000","student-portal-2-km6c.onrender.com",
...
# Media file settings (for student passport uploads)
MEDIA_URL = '/media/'
...
#LOGOUT_REDIRECT_URL = '/'
LOGIN_URL = "/login/"  # Redirect users to your custom login page
LOGIN_REDIRECT_URL = "student_list"  # Redirect to student list after login
